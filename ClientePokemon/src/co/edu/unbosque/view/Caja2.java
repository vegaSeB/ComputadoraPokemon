...
public class Caja2 extends JPanel{
	...
	private JButton retroceder2,avanzar2,equipop,cerrar;
	...
	public static final String RETROCEDER2 = "RETROCEDER2";
	public static final String AVANZAR2="AVANZAR2";
	...
	public Caja2() {
		...
		retroceder2 = new JButton();
		retroceder2.setActionCommand(RETROCEDER2);
		retroceder2.setBounds(262, 63, 24, 47);
		retroceder2.setOpaque(false);
		retroceder2.setContentAreaFilled(false);
		retroceder2.setBorderPainted(false);
		iconr = new ImageIcon("media/BotonAtras.png");
		retroceder2.setIcon(new ImageIcon(iconr.getImage().getScaledInstance(retroceder2.getWidth(), retroceder2.getHeight(), Image.SCALE_SMOOTH)));
		
		avanzar2 = new JButton();
		avanzar2.setActionCommand(AVANZAR2);
		avanzar2.setBounds(828, 63, 24, 47);
		avanzar2.setOpaque(false);
		avanzar2.setContentAreaFilled(false);
		avanzar2.setBorderPainted(false);
		icona = new ImageIcon("media/BotonAvanzo.png");
		avanzar2.setIcon(new ImageIcon(icona.getImage().getScaledInstance(avanzar2.getWidth(), avanzar2.getHeight(), Image.SCALE_SMOOTH)));
	...
	public JButton getRetroceder2() {
		return retroceder2;
	}

	public void setRetroceder2(JButton retroceder2) {
		this.retroceder2 = retroceder2;
	}

	public JButton getAvanzar2() {
		return avanzar2;
	}

	public void setAvanzar2(JButton avanzar2) {
		this.avanzar2 = avanzar2;
	}
